...
export const defaultConfig: BusinessConfig = {
  name: 'Dulsan Pastelería y Panadería',
  slogan: 'Somos el toque dulce para tu vida',
...
export const defaultAbout: AboutConfig = {
  ...
  text: 'En Dulsan Pastelería y Panadería creemos que cada bocado cuenta una historia. Desde 2015 brindamos los mejores momentos a nuestra comunidad, con ingredientes frescos, panes artesanales y un ambiente acogedor. Nuestro compromiso es ofrecerte no solo calidad, sino una experiencia inolvidable.',
};
...
export const defaultImages: ImagesConfig = {
  // Logo e imágenes base de Dulsan
  logoUrl: '/dulsan-logo.png',
  heroImage: '/dulsan-header.png',
  aboutUsImage: '/dulsan-about.png',
};
